...
typedef void (Q_DECL_STDCALL *P_CXDATA_CALLBACK)(std::unique_ptr<Struct_Datas<StructDataCX>>&);
typedef void (Q_DECL_STDCALL *P_ZCDATA_CALLBACK)(std::unique_ptr<Struct_Datas<StructDataZC>>&);
